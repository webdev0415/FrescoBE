...
describe('Invitation Service', () => {
    ...
    beforeEach(async () => {
        ...
        const module = await Test.createTestingModule({
            providers: [
                ...
                {provide: InvitationRepository, useFactory: mockInvitationRepository},
                {provide: UserToOrgRepository, useFactory: mockUserToOrgRepository},
    ...
    describe('checkPermission', () => {
        ...
        it(' return  true ', async () => {
            ...
            const result = await invitationService.checkPermission("frpmId", "toId")
    ...
    describe('create', () => {
        ...
        it(' Create with data, invalid permission', async () => {
            ...
            const result = invitationService.create("id", new SendInvitationDto())
        ...
        it(' resend for existing invite', async () => {
            ...
            invitationRepository.save.mockImplementation(async (value) => value);
        ...
        it(' new invite', async () => {
            ...
            invitationRepository.findOne = jest.fn(async () => invitationEntity)
    ...
    describe('verify', () => {
        ...
        it('verify valid Token ', async () => {
            ...
            expect(new LoginPayloadDto(invitationEntity.userInvite.toDto(), {
                accessToken: "token",
                expiresIn: 200
            })).toEqual(result)
